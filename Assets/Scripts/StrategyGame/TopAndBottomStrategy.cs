...
public class TopAndBottomStrategy : IGameStrategy
{
    public List<int> DoPair((int row, int col) cell1, (int row, int col) cell2, Cell[,] _array)
    {
        ...
        if (cell1.row <= (rowNum - 2) / 2)
        {
            ...
            matrix[(rowNum - 2) / 2, cell1.col].setState(0);
            matrix[(rowNum - 2) / 2, cell1.col].setRandomNum(0);
            IDs.Add(matrix[(rowNum - 2) / 2, cell1.col].getId());
        }
        else
        {
            for (int i = firstMoveRow; i > (rowNum - 2) / 2; i--)
            ...
            matrix[(rowNum - 2) / 2 + 1, cell1.col].setState(0);
            matrix[(rowNum - 2) / 2 + 1, cell1.col].setRandomNum(0);
            IDs.Add(matrix[(rowNum - 2) / 2 + 1, cell1.col].getId());
        ...
        if (cell2.row <= (rowNum - 2) / 2)
        {
            ...
            matrix[(rowNum - 2) / 2, cell2.col].setState(0);
            matrix[(rowNum - 2) / 2, cell2.col].setRandomNum(0);
            IDs.Add(matrix[(rowNum - 2) / 2, cell2.col].getId());
        }
        else
        {
            for (int i = secondMoveRow; i > (rowNum - 2) / 2; i--)
            ...
            matrix[(rowNum - 2) / 2 + 1, cell2.col].setState(0);
            matrix[(rowNum - 2) / 2 + 1, cell2.col].setRandomNum(0);
            IDs.Add(matrix[(rowNum - 2) / 2 + 1, cell2.col].getId());
